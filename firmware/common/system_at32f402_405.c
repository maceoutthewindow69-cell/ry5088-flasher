...
/** @addtogroup AT32F402_405_system_private_defines
  * @{
  */
/* This firmware links into the application slot behind the factory bootloader,
 * which jumps to the app vector table at 0x08005200. SystemInit() therefore
 * relocates VTOR to FLASH_BASE | 0x5200 (a multiple of 0x200, as the hardware
 * requires). */
